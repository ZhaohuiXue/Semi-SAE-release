...
[stAEOptThetaSPFNew, cost] = minFunc( @(p) stackedAECost3h(p, inputSize, hiddenSizeL3, ...
...
%  save 'E:\zsg_AE_CLASSIFICATION\Data\SemiSupervised_FineTuning_Data\IndianP_SemiS_FineT_Data\IndianPSPFFineT3.mat'  stAEOptThetaSPFNew1 inputSize hiddenSizeL3 numClasses netconfigSPF;
%%======================================================================
%%  Test 
...
[pred] = stackedAEPredict3h(stAEOptThetaSPFNew, inputSize, hiddenSizeL3, ...
...
[pred] = stackedAEPredict3h(stAEOptThetaSPFNew, inputSize, hiddenSizeL3, ...
                          numClasses,netconfigSPF, dataIndianPPatch);
classDataSPF = reshape(pred,M,N);

[probDataSPF] = stackedAEPredict3hProb(stAEOptThetaSPFNew, inputSize, hiddenSizeL3, ...
                          numClasses,netconfigSPF, dataIndianPPatch);
                      
save IndianPSPFFineT6.mat classDataSPF probDataSPF;
