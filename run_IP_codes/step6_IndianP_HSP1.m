...
[stAEOptThetaHSPNew1, cost] = minFunc( @(p) stackedAECost3h(p, inputSize, hiddenSizeL3, ...
    numClasses, netconfigHSP1, lambda, ...
    X_total(:,ind_train),  trainLabels), stackedAETheta, options);

save IndianPHSPFineT1.mat  stAEOptThetaHSPNew1 inputSize hiddenSizeL3 numClasses netconfigHSP1;
