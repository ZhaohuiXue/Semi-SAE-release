clear,pack,clc
load IndianP_regrow10BSPF4.mat regiongrowCELL2;
load IndianP_HSP.mat sae1OptTheta sae2OptTheta sae3OptTheta; 
load Indian_pines_corrected.mat IndianP_corrected;
...
[stAEOptThetaHSPNew, cost] = minFunc( @(p) stackedAECost3h(p, inputSize, hiddenSizeL3, ...
                                              numClasses, netconfigHSP, lambda, ...
                                              X,  trainLabels2), stackedAETheta, options);
% stAEOptThetaHSPNew4 = stAEOptThetaHSPNew3;
% save '..\HyperSpectralData\dataHSPTrain.mat'  stAEOptThetaHSPNew4 netconfigHSP3 -append;

%%======================================================================
%%  Test 
clear sae1OptTheta sae2OptTheta sae3OptTheta  ind_train trainLabels stack
...
[pred] = stackedAEPredict3h(stAEOptThetaHSPNew, inputSize, hiddenSizeL3, ...
...
% save('E:\zsg_e_disk\UFLDL-Tutorial-Exercise-master\UFLDL-Tutorial-Exercise-master\Indian Pines\AE_SPATIAL_FEATURES_UFLDL\gridSampling and Probability Merge\Classified Results\Classified Images\imagedataHSP.mat'...
%     ,'imHSPNew4');

[probDataHSP] = stackedAEPredict3hProb(stAEOptThetaHSPNew, inputSize, hiddenSizeL3, ...
                          numClasses, netconfigHSP, X_total);
% save('E:\zsg_e_disk\UFLDL-Tutorial-Exercise-master\UFLDL-Tutorial-Exercise-master\Indian Pines\AE_SPATIAL_FEATURES_UFLDL\gridSampling and Probability Merge\Classified Results\Classified Probability\probDataHSP.mat'...
%     ,'probDataHSP');
save IndianPHSPFineT5.mat classDataHSP probDataHSP;
